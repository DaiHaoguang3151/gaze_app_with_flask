...
from ptgaze.demo_for_flask import DemoForFlask
...
def load_mode_config(args: argparse.Namespace) -> DictConfig:
    ...
    package_root = package_root / 'ptgaze'  # todo: 这边是因为main拉到外面的目录了
...
def init_model_from_args() -> DemoForFlask:
    args = parse_args()
    args.mode = "eth-xgaze"
