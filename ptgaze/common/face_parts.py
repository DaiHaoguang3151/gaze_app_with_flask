...
class FaceParts:
    def __init__(self, name: FacePartsName):
        ...
        self.normalized_gaze_angles: Optional[np.ndarray] = None  # todo: 只有两个角
    ...
    def denormalize_gaze_vector(self) -> None:
        ...
        self.gaze_vector = self.normalized_gaze_vector @ normalizing_rot  # 这边用的右×，是将gaze_vector转换到世界坐标系下？
